...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference("Emprestimo.count") do
      post emprestimos_url, params: { emprestimo: { aluno_id: @emprestimo.aluno_id, data_devolucao: @emprestimo.data_devolucao, data_emprestimo: @emprestimo.data_emprestimo, livro_id: @emprestimo.livro_id, status: @emprestimo.status } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { aluno_id: @emprestimo.aluno_id, data_devolucao: @emprestimo.data_devolucao, data_emprestimo: @emprestimo.data_emprestimo, livro_id: @emprestimo.livro_id, status: @emprestimo.status } }
